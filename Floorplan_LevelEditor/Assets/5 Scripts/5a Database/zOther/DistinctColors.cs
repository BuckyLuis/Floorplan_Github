...
public class DistinctColors  {
    ...
    public static int colorIndexCounter = 0;
  
    public static string[] distinctColorsHexList = new string[] {    //http://stackoverflow.com/questions/33295120/how-to-generate-gif-256-colors-palette/33295456#33295456
    ...
    public static Color GetNextDistinctColor(int counterSet) {
        ...
        Color tempColor;
        ColorUtility.TryParseHtmlString (distinctColorsHexList[colorIndexCounter], out tempColor);  //hexColorString to Color
        colorIndexCounter++;
        return tempColor;
    }
 ...
 //   ColorUtility.TryParseHtmlString (hexString, out color);  //for hex color to Color
