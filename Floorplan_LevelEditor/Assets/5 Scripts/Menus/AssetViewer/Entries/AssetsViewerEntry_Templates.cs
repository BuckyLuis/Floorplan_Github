...
public class AssetsViewerEntry_Templates : MonoBehaviour {
    ...
    //------------- Asset Datas ------------------
    public Asset_Template_Base assetTemplate_BaseObject;
    ...
    void Start () {
        ...
        nameText.text = assetTemplate_BaseObject.assetName;
        usageText.text = assetTemplate_BaseObject.assetUsageSet;
        descText.text = assetTemplate_BaseObject.assetDesc;
        ...
        iconSprite = assetTemplate_BaseObject.assetEntryIcon;
    ...
    public void ThisSelected(bool toggleStatus) {                   //called by UItoggle
        ...
        textureViewerManageScript.ShowCompatTexAtlases(assetTemplate_BaseObject.meshsetString);
    ...
    public void SetSelectedMaterial(Material theMaterial) {
        assetTemplate_BaseObject.assetMaterial = theMaterial;
        assetTemplate_BaseObject.worldObjectPrefab.GetComponent<Renderer>().material = theMaterial;
    ...
    void SendInfoTo_TileToPaint() {
        tileToPaintScript.SetCurrentTileSprite(assetTemplate_BaseObject.assetEntryIcon);
